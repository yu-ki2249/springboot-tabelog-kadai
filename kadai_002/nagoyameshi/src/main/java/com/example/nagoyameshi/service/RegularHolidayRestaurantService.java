...
public class RegularHolidayRestaurantService {
    ...
    public RegularHolidayRestaurantService(RegularHolidayRestaurantRepository regularHolidayRestaurantRepository, RegularHolidayRepository regularHolidayRepository) {
